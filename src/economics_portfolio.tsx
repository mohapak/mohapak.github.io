...
/* ---------- Modal Component (moved outside main component) ---------- */
...
const EconomicsPortfolio: React.FC = () => {
  ...
  const toggleThemeSmooth = useCallback(() => {
    const root = document.documentElement;
              ...
              <div className="md:col-span-7">
                ...
                <div className="mt-6 flex flex-wrap gap-3">
                  <a 
                    ...
                    className="inline-flex items-center gap-2 rounded-xl bg-sky-500 hover:bg-sky-600 text-white px-4 py-2"
                  >
                    <FileText className="w-4 h-4" />
                    View Research
                  </a>
                  <a 
                    href="mailto:pakravanmohammad.eco@gmail.com" 
            ...
            <div className="mt-6 grid md:grid-cols-12 gap-8 items-center">
              <div className="md:col-span-7 space-y-3 text-slate-700 dark:text-slate-300">
                ...
                <p className="flex items-center gap-2">
                  ...
                  <a href="mailto:pakravanmohammad.eco@gmail.com" className="underline hover:text-sky-600">pakravanmohammad.eco@gmail.com</a>
                </p>
                <p className="flex items-center gap-2">
          ...
          <footer className="max-w-6xl mx-auto px-4 py-10 text-sm text-slate-500 border-t border-slate-200 dark:border-slate-800">
            <div className="flex flex-col md:flex-row items-center justify-between gap-4">
              ...
              <p>
                ...
                >
                  pakravanmohammad.eco@gmail.com
                </a>
              </p>
            </div>
          </footer>
